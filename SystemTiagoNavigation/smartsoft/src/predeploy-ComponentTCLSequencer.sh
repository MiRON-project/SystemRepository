#!/bin/bash
#
# This script is run prior to deployment of component ComponentTCLSequencer
...
source $REFERENCED_PROJECT_ComponentTCLSequencer/smartsoft/src/predeploy.sh
